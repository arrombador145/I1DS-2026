...
switch (periodo) {
  case "2":
    console.log("esse mês está no 1º trimestre do ano");
    break;
  case "4":
    console.log("esse mês está no 2º trimestre do ano");
    break;
  case "8":
    console.log("esse mês está no 3º trimestre do ano");
    break;
  case "11":
    console.log("esse mês está no 4º trimestre do ano");
}
//---------------------------------------------------------------
